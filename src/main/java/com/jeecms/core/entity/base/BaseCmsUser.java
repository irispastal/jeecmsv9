...
public abstract class BaseCmsUser  implements Serializable {
	...
	private java.util.Set<com.jeecms.core.entity.CmsUserIdcard> userIdcardSet;
	...
	public Set<com.jeecms.core.entity.CmsUserIdcard> getUserIdcardSet() {
		return userIdcardSet;
	}

	public void setUserIdcardSet(Set<com.jeecms.core.entity.CmsUserIdcard> userIdcardSet) {
		this.userIdcardSet = userIdcardSet;
	}
