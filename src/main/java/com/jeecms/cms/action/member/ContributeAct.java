...
public class ContributeAct extends AbstractContentMemberAct {
	...
	public String save(String title, String author, String description,
		...
		return super.save(title, author, description, txt, tagStr, channelId,modelId,
				...
				nextUrl,typeImg, request, response, model);
	}
	...
	@RequestMapping(value="/member/contribute_subCheck.jspx")
	public String subCheck(Integer id, HttpServletRequest request,
			HttpServletResponse response, ModelMap model){	
		return super.subCheck(CONTRIBUTE_LIST,
				id, request, model);
	}
